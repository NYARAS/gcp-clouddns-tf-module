variable "dns_zone_description" {
  type        = string
  description = "A short description of the purpose of this zone. You can also provide the URL to the GitLab Project that has the Terraform source code and CI pipelines."
